...
static char *ConsecstatHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module computes periods over all time steps in ifile where a",
...
static char *EofcoeffHelp[] = {
    ...
    "    EOF (time step) in ifile1 and suffix is the filename extension derived from the file format. ",
    "",
    "ENVIRONMENT",
    "    CDO_FILE_SUFFIX",
    "        This environment variable can be used to set the default file suffix. This suffix will be",
...
static char *IntyearHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This operator performs linear interpolation between two years, time step by time step.",
...
static char *WctHelp[] = {
    ...
    "    calculation is only valid for a temperature of T <= 33 째C and a wind speed",
    ...
    "    have to be given in units of 째C and m/s, respectively.",
    NULL
};
...
static char *FdnsHelp[] = {
    ...
    "    amounts. Then counted is the number of days where TN < 0 째C",
...
static char *EcaCddHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    Let ifile be a time series of daily precipitation amounts RR, then counted is the ",
    "    largest number of consecutive days where RR is less than R. R is an optional parameter with ",
    "    default R = 1 mm. A further output variable is the number of dry periods of more than 5 days.",
    "    The date information of a time step in ofile is the date of the last contributing ",
    "    time step in ifile.",
...
static char *EcaCfdHelp[] = {
    ...
    "    TN < 0 째C. Note that TN have to be given in units of Kelvin.",
    "    The date information of a time step in ofile is the date of",
    "    the last contributing time step in ifile.",
    "    The following variables are created: ",
...
static char *EcaCsuHelp[] = {
    ...
    "    The number T is an optional parameter with default T = 25 째C.",
...
static char *EcaCwdHelp[] = {
    ...
    "DESCRIPTION",
    "    Let ifile be a time series of daily precipitation amounts RR, then counted is the ",
    "    largest number of consecutive days where RR is at least R. R is an optional parameter with ",
...
static char *EcaCwdiHelp[] = {
    ...
    "    and T = 5 째C. A further output variable is the number of cold",
...
static char *EcaFdHelp[] = {
    ...
    "DESCRIPTION",
    "    Let ifile be a time series of daily minimum temperatures TN,",
    "    then counted is the number of days where TN < 0 째C. Note",
...
static char *EcaGslHelp[] = {
    ...
    "    and T = 5 째C. The number fland is an optional parameter with",
...
static char *EcaHdHelp[] = {
    ...
    "    of 17 째C is used for both parameters. If only T1 is given, T2 is",
...
static char *EcaHwdiHelp[] = {
    ...
    "    The numbers nday and T are optional parameters with default nday = 6",
    "    and T = 5 째C. A further output variable is the number of heat",
    "    waves longer than or equal to nday days. ",
...
static char *EcaIdHelp[] = {
    ...
    "DESCRIPTION",
    "    Let ifile be a time series of daily maximum temperatures TX,",
    "    then counted is the number of days where TX < 0 째C. Note",
...
static char *EcaRr1Help[] = {
    ...
    "DESCRIPTION",
    "    Let ifile be a time series of daily precipitation amounts RR, then counted is the ",
    "    number of days where RR is at least R. R is an optional parameter with ",
    "    default R = 1 mm. The date information of a time step in ofile is the date of",
    "    the last contributing time step in ifile.",
    "    The following variables are created: ",
...
static char *EcaSdiiHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    Let ifile be a time series of daily precipitation amounts RR, then the mean ",
...
static char *EcaSuHelp[] = {
    ...
    "    an optional parameter with default T = 25 째C. Note that TX",
...
static char *EcaTrHelp[] = {
    ...
    "    an optional parameter with default T = 20 째C. Note that TN",
    "    have to be given in units of Kelvin, whereas T have to be given in degrees Celsius.",
    "    The date information of a time step in ofile is the date of",
    "    the last contributing time step in ifile.",
    "    The following variables are created: ",

...
static char *ConsecstatHelp[] = {
    ...
    "    certain property is valid. The propery can be choosen by creating a mask from",
...
static char *EOFsHelp[] = {
    "NAME",
    "    eof, eoftime, eofspatial - Empirical Orthogonal Functions",
    "",
    "SYNOPSIS",
    ...
    "    After execution ofile1 will contain the eigen-values and ofile2 the",
    "    eigenvectors e_j. Note, thate the resulting EOF in ifile2 is ",
    "    e_j and thus not weighted for consistency.",
    "    ",
...
static char *EofcoeffHelp[] = {
    ...
    "    will be numbered as <obase>\\_<neof>.<suffix> where neof+1 is the number of the",

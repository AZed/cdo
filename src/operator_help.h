...
static char *FdnsHelp[] = {
    ...
    "    amounts. Then the number of days where TN < 0 째C and the surface ",
...
static char *EcaCddHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    Let ifile be a time series of daily precipitation amounts RR, then the largest number ",
...
static char *EcaCfdHelp[] = {
    ...
    "    then the largest number of consecutive days whereTN < 0 째C ",
...
static char *EcaFdHelp[] = {
    ...
    "DESCRIPTION",
    "    Let ifile be a time series of daily minimum temperatures TN,",
    "    then the number of days where TN < 0 째C is counted. Note",
...
static char *EcaIdHelp[] = {
    ...
    "DESCRIPTION",
    "    Let ifile be a time series of daily maximum temperatures TX,",
    "    then the number of days where TX < 0 째C is counted. Note",
...
static char *EcaR75pHelp[] = {
    ...
    "    amounts at wet days for any period used as reference. Then the percentage ",
    "    of wet days with RR > RRn75 is calculated. ",
...
static char *EcaR75ptotHelp[] = {
    ...
    "    Let ifile1 be a time series of daily precipitation amounts RR,",
    "    and ifile2 be the 75th percentile RRn75 of daily precipitation",
    "    amounts at wet days for any period used as reference. Then the ratio ",
    "    of the precipitation sum at wet days with RR > RRn75 to the total ",
...
static char *EcaR90pHelp[] = {
    ...
    "    amounts at wet days for any period used as reference. Then the percentage ",
    "    of wet days with RR > RRn90 is calculated. ",
...
static char *EcaR90ptotHelp[] = {
    ...
    "    and ifile2 be the 90th percentile RRn90 of daily precipitation",
    "    amounts at wet days for any period used as reference. Then the ratio ",
    "    of the precipitation sum at wet days with RR > RRn90 to the total ",
    "    precipitation sum is calculated. ",
    "    RRn90 is calculated as the 90th percentile of all wet days of a given",
    "    climate reference period.",
    "    The date information of a timestep in ofile is the date of",
...
static char *EcaR95pHelp[] = {
    ...
    "    amounts at wet days for any period used as reference. Then the percentage ",
    "    of wet days with RR > RRn95 is calculated. ",
...
static char *EcaR95ptotHelp[] = {
    ...
    "    and ifile2 be the 95th percentile RRn95 of daily precipitation",
    "    amounts at wet days for any period used as reference. Then the ratio ",
    "    of the precipitation sum at wet days with RR > RRn95 to the total ",
    "    precipitation sum is calculated. ",
    "    RRn95 is calculated as the 95th percentile of all wet days of a given",
    "    climate reference period.",
    "    The date information of a timestep in ofile is the date of",
...
static char *EcaR99pHelp[] = {
    ...
    "    amounts at wet days for any period used as reference. Then the percentage ",
    "    of wet days with RR > RRn99 is calculated. ",
...
static char *EcaR99ptotHelp[] = {
    ...
    "    and ifile2 be the 99th percentile RRn99 of daily precipitation",
    "    amounts at wet days for any period used as reference. Then the ratio ",
    "    of the precipitation sum at wet days with RR > RRn99 to the total ",
    "    precipitation sum is calculated. ",
    "    RRn99 is calculated as the 99th percentile of all wet days of a given",
    "    climate reference period.",
    "    The date information of a timestep in ofile is the date of",
...
static char *EcaRr1Help[] = {
    ...
    "",
    "DESCRIPTION",
    "    Let ifile be a time series of daily precipitation amounts RR, then the number of ",
